...
def file_processor(file_name, initializer_string):
    ...
    end of the Gutenberg licence. It removes the licence, and does
    basic text preprocessing, returning the processed text'''
    fh = open(file_name,'r')
    raw = fh.read()
    fh.close()
    ...
    processed = text_preprocessing(licence_removed)
    return processed
